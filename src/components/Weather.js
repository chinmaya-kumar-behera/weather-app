...
//         // Filter forecast data to include only the previous 7 days
//         const filteredForecastData = forecastWeatherData.list
//           .filter((forecast) => new Date(forecast.dt * 1000) >= sevenDaysAgo)
//           .slice(0, 7);
...
//       </header>
//       {loading ? (
//         <div>Loading...</div> // Render loader when data is being fetched
//       ) : (
//         <>
//           {/* Render weather data when loading is false */}
//           {currentData && (
//             <div className="flex justify-center items-center space-y-5">
//               <div className="">
//                 <h2 className="text-4xl">{currentData.name}</h2>
...
//                   <div className="flex gap-5">
//                     <span>
//                       Wind Speed {parseInt(currentData.wind.speed)} Km/h
//                     </span>
//                     <span>
//                       Feels Like {parseInt(currentData.main.feels_like)}° C
//                     </span>
//                     <span>{parseInt(currentData.main.pressure)}</span>
//                   </div>
//                   <div className="flex gap-5">
//                     <span>Humidity {parseInt(currentData.main.humidity)}%</span>
//                     <span>{parseInt(currentData.visibility)}</span>
//                   </div>
//                 </section>
//               </div>
//             </div>
  ...
  useEffect(() => {
    const fetchData = async () => {
      navigator.geolocation.getCurrentPosition(async function (position) {
        ...
        // Filter forecast data to include only the current week
